    ...
    return (
        <Dropdown show={dropdownOpen} onToggle={toggleDropdown}>
            <Dropdown.Toggle
                ...
                className={classNames('nav-link', 'position-relative', 'cursor-pointer', 'notification-list', {
                    show: dropdownOpen,
                })}>
                <FeatherIcon icon="bell" />
                <span className="top-0 d-inline-block badge bg-danger rounded-circle noti-icon-badge">6</span>
            </Dropdown.Toggle>
